...
function AddCanteenProduct({navigation, route }) {
 ...
 // khi nao can dung toi IOS
  ...
  function postData(){
    ...
    axios.post('https://vlu-ewallet.herokuapp.com/canteen-manager/newProduct', {
       name: name,
       price: price,
       image:picture,
       barcode:barcode
       ...
       if(res.data == 'Success' ) {
         setLoad(false);
         navigation.navigate('Căn tin',{post:'add'});
       }else{
         setLoad(false);
        ...
        <View style={styles.container}>
            ...
            <View style={{flexDirection:"row", alignItems:'center'}}>
              <View style={styles.inputContainer}>
                ...
                />
                <TouchableOpacity style={styles.barcode} onPress={()=>navigation.navigate('Scan',{screen:'addCanteen'})}>
            ...
            <TouchableOpacity style={styles.icon}>
              ...
              <TouchableOpacity style={styles.icon} onPress={()=>navigation.navigate('Camera',{screen:'addCanteen'})}>
